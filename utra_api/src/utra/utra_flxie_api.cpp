...
int UtraFlxiE2Api::reset_err(void) { return utra_api_->set_utrc_int8_now(line_, id_, reg_.RESET_ERR[0], reg_.RESET_ERR[0]); }
...
int UtraFlxiE2Api::erase_parm(void) { return utra_api_->set_utrc_int8_now(line_, id_, reg_.ERASE_PARM[0], reg_.ERASE_PARM[0]); }
int UtraFlxiE2Api::saved_parm(void) { return utra_api_->set_utrc_int8_now(line_, id_, reg_.SAVED_PARM[0], reg_.SAVED_PARM[0]); }
...
int UtraFlxiE2Api::get_vel_current(float *value) {
  return utra_api_->get_utrc_float_now(line_, id_, reg_.VEL_CURRENT[0], value);
}
...
int UtraFlxiE2Api::get_vel_pidp(float *value) {
  return utra_api_->get_utrc_float_now(line_, id_, reg_.VEL_PIDP[0], value);  //
}
int UtraFlxiE2Api::set_vel_pidp(float value, bool now) {
  if (now)
    return utra_api_->set_utrc_float_now(line_, id_, reg_.VEL_PIDP[0], value);
  else
    return utra_api_->set_utrc_float_que(line_, id_, reg_.VEL_PIDP[0], value);
}
int UtraFlxiE2Api::get_vel_pidi(float *value) {
  return utra_api_->get_utrc_float_now(line_, id_, reg_.VEL_PIDI[0], value);  //
}
int UtraFlxiE2Api::set_vel_pidi(float value, bool now) {
  if (now)
    return utra_api_->set_utrc_float_now(line_, id_, reg_.VEL_PIDI[0], value);
  else
    return utra_api_->set_utrc_float_que(line_, id_, reg_.VEL_PIDI[0], value);
}
int UtraFlxiE2Api::get_vel_smooth_cyc(uint8_t *value) {
  return utra_api_->get_utrc_int8_now(line_, id_, reg_.VEL_SMOOTH_CYC[0], value);
}
int UtraFlxiE2Api::set_vel_smooth_cyc(uint8_t value, bool now) {
  if (now)
    return utra_api_->set_utrc_int8_now(line_, id_, reg_.VEL_SMOOTH_CYC[0], value);
  else
    return utra_api_->set_utrc_int8_que(line_, id_, reg_.VEL_SMOOTH_CYC[0], value);
}
