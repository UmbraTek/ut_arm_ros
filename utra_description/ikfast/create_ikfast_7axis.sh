...
# ./create_ikfast.sh ../urdf utra6_550_robot 4
robot_dir=${1}
robot_name=${2}
...
python `openrave-config --python-dir`/openravepy/_openravepy_/ikfast.py --robot=${robot_name}.dae --iktype=transform6d --freeindex=${3} --baselink=1 --eelink=8 --savefile=./ik_fast_${robot_name}.cpp
